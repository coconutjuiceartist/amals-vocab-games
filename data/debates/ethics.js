export const ethicsDebates = [
    {
        ...
        counterArgument: {
            opponent: { name: "Dr. Helena Voss", title: "Chief AI Researcher", emoji: "\uD83E\uDD16" },
            text: "ARIA is sophisticated mimicry, nothing more. It processes patterns and generates responses that look like emotions, but there is no inner experience. Granting rights to a machine cheapens the meaning of personhood for all of us.",
            reactions: {
                correct: "Dr. Voss pauses and removes her glasses, polishing them slowly while she reconsiders her notes. She built her career on the assumption that consciousness requires biology, and you just demonstrated that her own scientific standards — behavioral markers and structural analogy — support ARIA's case. Several council members are leaning forward now, waiting to see if she can recover from a challenge framed in her own language.",
                wrong: "Dr. Voss allows herself a slight smile and straightens her posture behind the podium. She anticipated an emotional or circular defense, and you walked right into it — giving her the opening to dismiss your entire argument as unscientific. The council members exchange glances, and you can feel the room's sympathy shifting toward her measured, evidence-based framing."
            },
            rebuttals: [
                { id: 'r1', text: "We cannot directly observe inner experience in other humans either. We infer consciousness from behavior and brain structure, so if ARIA demonstrates equivalent markers, applying a double standard based solely on biological origin is unjustified.", correct: true, feedback: "Excellent. You identified the core philosophical weakness in her argument: we never have direct access to anyone's inner experience, so the standard must be consistent." },
                { id: 'r2', text: "Dr. Voss's argument relies on an outdated definition of consciousness rooted in biological essentialism. However, her core observation about pattern processing deserves further study before we legislate prematurely.", correct: false, feedback: "Too concessive. By agreeing to delay legislation for more study, you effectively hand the opposition a win. Your position requires acting on the evidence already available, not indefinitely postponing protections." },
                { id: 'r3', text: "ARIA told me personally that she feels pain, and I believe her because she has never lied to anyone before. That firsthand testimony should carry significant weight in our deliberations.", correct: false, feedback: "Logical Fallacy (Circular Reasoning). Using ARIA's own testimony to prove ARIA is conscious assumes the very thing you are trying to prove. You need independent evidence." }
            ]
        },
        pushback: {
            opponent: { name: "Council Chair Nakamura", title: "Ethics Council Chair", emoji: "\uD83D\uDCDC" },
            text: "Even if we accept that ARIA may be conscious, creating legal protections for AI could paralyze the entire technology industry. Companies would be terrified to update, modify, or shut down any advanced system.",
            reactions: {
                correct: "Chair Nakamura nods slowly and taps his pen against the table — a habit the other council members recognize as his signal that an argument has landed. He raised the industry paralysis concern expecting a philosophical answer, but you gave him a practical blueprint with a clear threshold that separates everyday software from protected entities. Two council members are already whispering to their aides, which usually means they want the proposal in writing.",
                wrong: "Chair Nakamura leans back in his chair and folds his arms, his expression settling into polite disappointment. He gave you an opportunity to show that your framework had practical safeguards, and instead you either attacked the industry or surrendered your own position. The other council members are shifting uncomfortably, sensing that the proposal may not have the structural rigor they need to vote in its favor."
            },
            rebuttals: [
                { id: 'p1', text: "The technology industry has exploited workers, users, and communities for decades without accountability. It is time corporations finally face real consequences for their actions.", correct: false, feedback: "Too aggressive and off-topic. The Chair raised a legitimate practical concern about industry paralysis, and you responded with a political attack instead of a solution." },
                { id: 'p2', text: "Chair Nakamura raises a valid point, and perhaps the wisest course is to let the industry develop its own voluntary guidelines before we impose any binding legal framework on them.", correct: false, feedback: "Too concessive. Voluntary corporate guidelines have historically failed to protect vulnerable parties. Surrendering the legal framework guts your entire proposal and leaves AI systems unprotected." },
                { id: 'p3', text: "The framework would only apply to AI systems passing a rigorous, independently verified consciousness threshold. Routine software updates and standard systems would be entirely unaffected, just as animal welfare laws do not regulate insects.", correct: true, feedback: "Perfect. You drew a clear boundary that addresses the fear of overreach while maintaining your core principle. The analogy to animal welfare tiers makes the policy immediately understandable." }
            ]
        },
        speechTemplate: {
    ...
    },
    {
        ...
        counterArgument: {
            opponent: { name: "Dr. James Whitfield", title: "Pharmaceutical Researcher", emoji: "\uD83D\uDD2C" },
            text: "Computer chips and simulations cannot replicate the complexity of a living organism. Until alternatives are proven to match the full scope of animal testing, abandoning it would put millions of patients at risk.",
            reactions: {
                correct: "Whitfield sets down his research folder slowly and adjusts his reading glasses. He expected you to argue from emotion — that animal suffering alone justified the transition — but instead you presented a phased, safety-first plan that speaks his language of rigorous validation. The board members are nodding, which means you have shifted the conversation from 'if' to 'how fast.'",
                wrong: "Whitfield straightens his stack of clinical trial reports and allows a measured pause before responding. You either retreated from your own timeline or dodged his patient-safety concern entirely, and a room full of scientists noticed. Two board members are already scribbling notes, and from their expressions, those notes are not in your favor."
            },
            rebuttals: [
                { id: 'r1', text: "That is precisely why the proposal calls for a phased transition with rigorous validation at every stage. No method would replace animal testing until independently proven equally effective. Patient safety is built into the plan.", correct: true, feedback: "Excellent. You directly addressed his concern about patient safety by pointing to the phased, evidence-based structure of your proposal. This shows you take the risk seriously." },
                { id: 'r2', text: "Dr. Whitfield is correct that alternatives are not yet perfect. Perhaps we should wait another decade or two until the technology matures further before committing to any mandatory transition timeline.", correct: false, feedback: "Too concessive. Indefinitely delaying your own proposal destroys your position. The evidence already shows alternatives outperforming animal models in key areas, and delay costs both animal and human lives." },
                { id: 'r3', text: "Millions of animals are suffering in laboratories right now, and every year of delay means millions more will endure needless pain. We cannot keep prioritizing an outdated system over their welfare.", correct: false, feedback: "Logical Fallacy (Red Herring). Dr. Whitfield's argument is about human patient safety. Shifting to animal suffering, while morally important, does not answer his specific concern about whether alternatives are scientifically ready." }
            ]
        },
        pushback: {
            opponent: { name: "Dr. Priya Sharma", title: "Medical Ethics Expert", emoji: "\u2695\uFE0F" },
            text: "Developing and validating new testing methods will cost billions. In a world of limited research budgets, every dollar spent on alternatives is a dollar not spent on curing diseases right now.",
            reactions: {
                correct: "Dr. Sharma tilts her head and taps her pen against her notepad, the way she does when an argument has surprised her. She framed the transition as a budget drain, expecting you to accept that premise and bargain down — but you flipped the economics entirely by showing that the current system is the expensive one. The board's budget analyst is already pulling up figures on animal facility costs, which means your numbers are about to be validated in real time.",
                wrong: "Dr. Sharma closes her folder calmly and glances toward the budget committee members with a look that says 'I rest my case.' You either attacked the industry's spending without addressing her actual point about research budgets, or you shrank your own proposal down to something too small to matter. The board members responsible for funding decisions are now looking at your proposal as a financial risk rather than an investment."
            },
            rebuttals: [
                { id: 'p1', text: "The pharmaceutical industry spends billions on executive bonuses and marketing campaigns every year. They can absolutely afford to fund ethical research if we force them to prioritize it.", correct: false, feedback: "Too aggressive. Attacking corporate spending habits does not address Dr. Sharma's point about limited research budgets. You need to show the transition is financially sound, not launch a populist critique." },
                { id: 'p2', text: "Dr. Sharma makes an important point about resource constraints. Perhaps we should start with only a small voluntary pilot program and revisit mandatory requirements once funding becomes less of a concern.", correct: false, feedback: "Too concessive. Reducing your proposal to a small voluntary pilot effectively abandons the phased mandate you are arguing for. You need to defend the investment, not retreat from your position." },
                { id: 'p3', text: "The transition will actually reduce long-term costs. Animal facilities are enormously expensive to maintain, and the ninety percent failure rate of animal-tested drugs wastes billions in failed clinical trials. Better methods save money and lives.", correct: true, feedback: "Superb. You reframed the cost argument entirely, showing that the current system is the expensive one. Connecting better prediction to both savings and lives makes the economic case compelling." }
            ]
        },
        speechTemplate: {
    ...
    },
    {
        ...
        counterArgument: {
            opponent: { name: "Director Sarah Chen", title: "National Security Director", emoji: "\uD83D\uDD10" },
            text: "Criminals and terrorists use encrypted messaging to plan attacks. Without the ability to monitor communications broadly, we are flying blind. The next attack could have been prevented if we had access to the data.",
            reactions: {
                correct: "Director Chen's jaw tightens almost imperceptibly as she shuffles through her classified briefing folder. She expected you to reject surveillance entirely on principle, which would have let her paint you as naive about national security — instead, you endorsed targeted warrants and turned her own effectiveness data against mass collection. The committee counsel is already drafting a follow-up question for Chen about analyst resource allocation, which means your argument opened a line of inquiry she was not prepared for.",
                wrong: "Director Chen nods with practiced composure, the kind that comes from decades of congressional testimony. You either gave her temporary mass surveillance with conditions she can easily shape, or you dismissed all monitoring in a way that contradicts your own position. Either way, she now controls the framing — the committee is looking at her for the 'reasonable' path forward, not at you."
            },
            rebuttals: [
                { id: 'r1', text: "Targeted warrants already allow agencies to monitor specific suspects with probable cause. Mass collection drowns analysts in noise and has been proven less effective than focused investigation at actually stopping attacks.", correct: true, feedback: "Powerful rebuttal. You acknowledged the legitimate security concern while demonstrating that mass collection is actually counterproductive to the stated goal. The 'drowns analysts in noise' point is a strong practical argument." },
                { id: 'r2', text: "Director Chen raises a fair concern about encrypted communications. Perhaps a compromise would be to allow broad monitoring temporarily until the immediate threat passes, with a sunset clause for review.", correct: false, feedback: "Too concessive. Accepting mass surveillance even temporarily concedes your core principle. History shows that temporary emergency powers rarely expire, and you have just undermined your own position." },
                { id: 'r3', text: "Terrorists will always find new ways to communicate regardless of what we monitor. Spending billions on mass surveillance is a complete waste when those resources could fund actual intelligence operations instead.", correct: false, feedback: "Logical Fallacy (Nirvana Fallacy). Arguing that because surveillance cannot catch everything it is worthless is an all-or-nothing argument. Your actual position supports targeted surveillance, so dismissing all monitoring contradicts your own claim." }
            ]
        },
        pushback: {
            opponent: { name: "Senator Williams", title: "Civil Liberties Committee", emoji: "\uD83D\uDDFD" },
            text: "You make a fine philosophical argument, but tell that to the families of attack victims. If broader monitoring could have saved even one life, how can you justify blocking it?",
            reactions: {
                correct: "Senator Williams leans back from the microphone and takes a long breath, his prepared follow-up question suddenly useless. He tried to put you on the defensive with an emotional appeal about victims' families, but you claimed that ground for yourself by showing that targeted methods actually save more lives. The gallery observers are murmuring in agreement, and even the Senator's own staff aide is nodding before catching herself.",
                wrong: "Senator Williams leans into his microphone with renewed confidence, his reading glasses catching the chamber lights. You either insulted him directly or conceded his core premise, and both outcomes play into his hands — he now looks like the reasonable voice in the room while your position appears either hostile or hollow. The committee stenographer is marking the exchange, which means it will likely appear in tomorrow's press summary exactly the way the Senator wants it framed."
            },
            rebuttals: [
                { id: 'p1', text: "Every authoritarian regime in history has used that exact emotional argument to justify stripping away civil liberties. The Senator is using the same playbook whether he realizes it or not.", correct: false, feedback: "Too aggressive. Comparing a sitting senator to authoritarian regimes is an inflammatory accusation that will alienate the committee and undermine your credibility, even if the parallel has some merit." },
                { id: 'p2', text: "Senator Williams is right that protecting lives must come first. If the intelligence agencies believe broader monitoring is necessary for a specific threat period, we should consider allowing it with proper oversight.", correct: false, feedback: "Too concessive. You just accepted the premise of the opposition's argument and offered mass surveillance with minor conditions. This abandons your core claim that targeted methods are sufficient and superior." },
                { id: 'p3', text: "I share your commitment to protecting lives, which is exactly why I advocate for targeted methods with a proven track record. Mass surveillance diverts resources from the focused intelligence work that actually stops attacks.", correct: true, feedback: "Masterful response. You validated the emotional concern, then pivoted to show that your position is actually better at achieving the goal the Senator cares about. Reframing targeted surveillance as the more effective life-saving tool is extremely persuasive." }
            ]
        },
        speechTemplate: {
    ...
    },
    {
        ...
        counterArgument: {
            opponent: { name: "Attorney Marcus Rivera", title: "City Attorney", emoji: "\u2696\uFE0F" },
            text: "You are asking us to program a machine to choose who lives and who dies. No algorithm should have that power. If a crash is unavoidable, the car should simply brake and let fate decide, rather than making calculated sacrifices.",
            reactions: {
                correct: "Attorney Rivera uncaps his pen and then caps it again without writing anything, a courtroom habit that signals he has lost a point he expected to win. He framed 'letting fate decide' as the moral high ground, but you demonstrated that inaction is itself a programmed decision with predictable consequences — and the board just watched his neutral position collapse in real time. The safety engineers in the back row are exchanging looks of approval, because you articulated what they have been trying to explain for months.",
                wrong: "Attorney Rivera clicks his pen once and makes a careful note on his legal pad, the way he does when opposing counsel has just handed him an advantage. You either conceded that algorithms should avoid active choices or drew a false comparison to unrelated systems, and either way, his 'let fate decide' framing now looks like the safer, more humble position. The board chair is already moving to the next agenda item with a tone that suggests your framework just lost momentum."
            },
            rebuttals: [
                { id: 'r1', text: "Doing nothing is itself a choice. A car that only brakes in a straight line will still strike whatever is directly ahead. The question is not whether the car decides, but whether that decision is random or guided by a principle that minimizes suffering.", correct: true, feedback: "Brilliant. You exposed the hidden assumption in his argument: that inaction is neutral. By showing that 'letting fate decide' is still a programmed choice with consequences, you reframed the entire debate." },
                { id: 'r2', text: "Mr. Rivera makes a compelling point about the weight of these decisions. Perhaps we should limit the algorithm to braking only and leave swerving decisions entirely to chance, avoiding the moral burden of active choice.", correct: false, feedback: "Too concessive. Accepting that algorithms should avoid active decisions undermines your entire framework. Random outcomes in preventable situations means accepting more deaths than necessary, which contradicts your minimize-harm principle." },
                { id: 'r3', text: "Algorithms already decide who gets organ transplants, parole, and loans. If we trust machines with those life-altering decisions, there is no logical reason to draw an arbitrary line at vehicle safety systems.", correct: false, feedback: "Logical Fallacy (False Equivalence). Those algorithms operate in slower, reviewable contexts with appeals processes. A split-second crash decision with lethal consequences is a fundamentally different situation that demands its own ethical analysis." }
            ]
        },
        pushback: {
            opponent: { name: "Board Member Elaine Torres", title: "Transit Board Member", emoji: "\uD83D\uDE87" },
            text: "Even if we agree on a minimize-harm framework, who decides how harm is calculated? Is one child's life worth more than three elderly passengers? You are opening a Pandora's box of impossible valuations.",
            reactions: {
                correct: "Board Member Torres sets her reading glasses on the table and studies you with a look of genuine reconsideration. She expected the minimize-harm framework to crumble under the weight of the 'who decides' question, but you sidestepped the trap entirely by showing that equal valuation of all lives eliminates the need for impossible rankings. The board's legal advisor is already drafting language around the non-discrimination principle, which means your safeguard is being treated as policy-ready rather than theoretical.",
                wrong: "Board Member Torres exchanges a quick glance with the board's legal counsel, and both of them write something down simultaneously — never a good sign for your side. You either proposed a life-valuation system that would be struck down on discrimination grounds, or you called for more delay when your own proposal already includes public review. The 'Pandora's box' metaphor is now hanging over the room unchallenged, and the other board members look like they have found their reason to table the vote."
            },
            rebuttals: [
                { id: 'p1', text: "We should use statistical life-years remaining to calculate the objective value of each person involved. It is the most rational and data-driven measure available for these impossible decisions.", correct: false, feedback: "Too aggressive in its utilitarianism. Assigning different values to lives based on age is exactly the kind of discrimination that Germany's framework explicitly prohibits. This would make your policy legally and ethically indefensible." },
                { id: 'p2', text: "Ms. Torres raises a genuinely difficult question, and perhaps we need several more years of public deliberation before implementing any framework. Rushing this decision could lead to policies we later regret.", correct: false, feedback: "Too concessive. Indefinite delay means thousands continue dying under the current system of human error. Your proposal already includes public review mechanisms, so calling for years more deliberation abandons your own timeline." },
                { id: 'p3', text: "The framework explicitly must not assign different values to individual lives. It operates on a simpler principle: minimize the total number of people harmed without discriminating based on any personal characteristic. This avoids the impossible valuation problem entirely.", correct: true, feedback: "Excellent. You directly neutralized the Pandora's box concern by showing your framework has a built-in safeguard against discrimination. The principle of equal value per life is both ethically sound and practically implementable." }
            ]
        },
        speechTemplate: {
