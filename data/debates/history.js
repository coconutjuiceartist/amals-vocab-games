export const historyDebates = [
    {
        ...
        counterArgument: {
            ...
            rebuttals: [
                ...
                { id: 'r3', text: "Ambassador Chen raises a fair point about the internet's reach, but online access still requires infrastructure that many developing nations lack, so a physical center provides an essential backup.", correct: false, feedback: "This concedes too much ground. Calling the library merely a 'backup' to the internet undermines your core argument that it serves a unique and irreplaceable role in knowledge preservation." }
            ]
        },
        pushback: {
            ...
            rebuttals: [
                ...
                { id: 'p3', text: "The project uses a tiered international partnership model where nations contribute based on GDP, supplemented by tech company sponsorships and a global digital access subscription costing less than a dollar per user annually.", correct: true, feedback: "Excellent practical response. You provided a specific, realistic funding model that addresses the concern directly without either dismissing it or abandoning your proposal." }
            ]
        },
        speechTemplate: {
    ...
    },
    {
        ...
        counterArgument: {
            ...
            rebuttals: [
                ...
                { id: 'r3', text: "Governor Rustam raises an important point, and perhaps we should allow each nation to keep whatever tariffs they feel are necessary to protect their industries from outside competition.", correct: false, feedback: "Too concessive. Allowing unlimited protective tariffs defeats the entire purpose of an open trade charter and essentially gives away your core argument." }
            ]
        },
        pushback: {
            ...
            rebuttals: [
                ...
                { id: 'p3', text: "The charter proposes jointly funded garrison outposts every two hundred miles along major routes, staffed by soldiers from each participating nation, creating shared responsibility and reducing costs for any single nation.", correct: true, feedback: "A concrete, detailed security plan that directly answers the concern. The shared-cost model also reinforces the cooperative spirit of the agreement." }
            ]
        },
        speechTemplate: {
    ...
    },
    {
        ...
        counterArgument: {
            ...
            rebuttals: [
                ...
                { id: 'r3', text: "The Senator is absolutely right that poverty is devastating, and perhaps we should consider reducing some of NASA's manned missions to free up funds for domestic programs.", correct: false, feedback: "Too concessive. Volunteering to cut your own program's core mission undermines your entire argument and gives opponents exactly what they wanted." }
            ]
        },
        pushback: {
            ...
            rebuttals: [
                ...
                { id: 'p3', text: "History shows breakthroughs emerge from ambitious integrated programs, not isolated labs. Spaceflight forces engineers to solve unexpected problems, producing civilian applications like miniaturized circuits now revolutionizing computing.", correct: true, feedback: "You answered the cost-effectiveness question with a concrete example and explained the mechanism by which space programs uniquely drive innovation." }
            ]
        },
        speechTemplate: {
    ...
    },
    {
        ...
        counterArgument: {
            ...
            rebuttals: [
                ...
                { id: 'r3', text: "Board Member Thornton is right that job readiness matters enormously. We should perhaps make the indigenous language component optional rather than mandatory so families can choose based on their priorities.", correct: false, feedback: "Too concessive. Making the program optional undermines your core claim that it should be mandatory, and optional programs historically receive less funding and lower enrollment." }
            ]
        },
        pushback: {
            ...
            rebuttals: [
                ...
                { id: 'p3', text: "The program includes a Language Keeper apprenticeship track pairing fluent elders with younger community members who receive teaching certification, simultaneously preserving the language and building a sustainable instructor pipeline.", correct: true, feedback: "A creative, practical solution that directly addresses the teacher shortage while also serving the preservation mission. This shows you have thought beyond the policy into its implementation." }
            ]
        },
        speechTemplate: {
