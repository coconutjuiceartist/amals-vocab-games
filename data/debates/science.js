export const scienceDebates = [
    {
        ...
        counterArgument: {
            ...
            rebuttals: [
                ...
                { id: 'r2', text: "Climate change is exaggerated by the media, so we don't need to worry about Earth as much as she claims.", correct: false, feedback: "Dismissing established science destroys your credibility before a panel of scientists. Never deny evidence to win a point." },
                { id: 'r3', text: "If Earth is already doomed like you say, that is exactly why we need Mars even more urgently.", correct: false, feedback: "Logical Fallacy (Straw Man). She did not say Earth is doomed; she said we should prioritize fixing it. Misrepresenting her argument weakens your position." }
            ]
        },
        pushback: {
            ...
            rebuttals: [
                { id: 'p1', text: "Space exploration has always been more important than short-term problems on Earth.", correct: false, feedback: "Dismissing poverty as a 'short-term problem' is callous and alienates the council. You must show empathy for real human suffering." },
                { id: 'p2', text: "The terraforming initiative can be structured so that satellite technology, agricultural research, and water purification systems developed for Mars are deployed in developing nations first, making it a dual-purpose investment.", correct: true, feedback: "Excellent compromise. You directly addressed the concern by linking the Mars project to immediate humanitarian benefits on Earth." }
            ]
        },
        speechTemplate: {
    ...
    },
    {
        ...
        counterArgument: {
            ...
            rebuttals: [
                ...
                { id: 'r2', text: "Rich people already have advantages in everything, so genetic enhancement would not change much.", correct: false, feedback: "Logical Fallacy (Two Wrongs Make a Right). Existing inequality does not justify creating a new, permanent form of biological inequality." },
                { id: 'r3', text: "Professor Tanaka is just afraid of progress and wants children to keep suffering from preventable diseases.", correct: false, feedback: "Logical Fallacy (Ad Hominem / Straw Man). Attacking his motives rather than his argument is disrespectful and unconvincing to the board." }
            ]
        },
        pushback: {
            ...
            rebuttals: [
                { id: 'p1', text: "Eliminating diseases is objectively good, and people should not take medical progress personally.", correct: false, feedback: "Dismissive and insensitive. Disability communities raise a legitimate concern about how society values different lives. Ignoring their perspective will lose you allies." },
                { id: 'p2', text: "Preventing suffering is not the same as devaluing those who live with it. We treat cancer without suggesting cancer survivors are lesser people. Gene editing targets the disease, not the person.", correct: true, feedback: "Beautifully stated. You drew a clear distinction between eliminating disease and devaluing people, using a relatable analogy that respects the concern." }
            ]
        },
        speechTemplate: {
    ...
    },
    {
        ...
        counterArgument: {
            ...
            rebuttals: [
                { id: 'r1', text: "Ocean research drives equally transformative innovation. Sonar technology, underwater robotics, and pressure-resistant materials all have applications across medicine, engineering, and defense. Equal funding means more total innovation, not less.", correct: true, feedback: "Excellent. You matched his examples with equally compelling ocean-derived innovations and reframed the debate as additive, not zero-sum." },
                { id: 'r2', text: "GPS and satellites are old technology. Space hasn't produced anything groundbreaking in years.", correct: false, feedback: "Factually incorrect and easily disproven. The James Webb Space Telescope and Mars rovers are recent, widely celebrated achievements. Making false claims destroys your credibility." },
                { id: 'r3', text: "Director Zhang is only defending space funding because it protects his own department's budget.", correct: false, feedback: "Logical Fallacy (Ad Hominem). Attacking his motives instead of his argument is unprofessional and does not address the substance of his point." }
            ]
        },
        pushback: {
            ...
            rebuttals: [
                { id: 'p1', text: "Space missions are overfunded anyway, so a 40% cut would just trim the excess.", correct: false, feedback: "Dismissive and unsupported. You cannot claim 'overfunding' without evidence, and this alienates the space scientists whose cooperation you need." },
                { id: 'p2', text: "The rebalancing can be phased over ten years, prioritizing joint ocean-space projects like Earth observation satellites and underwater-to-orbital communication systems, so no active missions are disrupted.", correct: true, feedback: "Smart and practical. A phased transition with joint projects shows you respect existing commitments while building toward equal funding." }
            ]
        },
        speechTemplate: {
    ...
    },
    {
        ...
        counterArgument: {
            ...
            rebuttals: [
                { id: 'r1', text: "Modern grid-scale battery storage, pumped hydro, and green hydrogen systems can store renewable energy for days or weeks. Intermittency is an engineering problem that is already being solved, not a fundamental flaw.", correct: true, feedback: "Excellent. You directly addressed the technical concern with specific, existing solutions rather than dismissing his worry." },
                { id: 'r2', text: "Fossil fuels are also unreliable because oil prices crash and pipelines leak.", correct: false, feedback: "Logical Fallacy (Whataboutism / Tu Quoque). Pointing out flaws in fossil fuels does not answer the specific question about renewable intermittency. You must address his concern directly." },
                { id: 'r3', text: "People said the same thing about every new technology. Cars were called unreliable too, and look at them now.", correct: false, feedback: "Logical Fallacy (Weak Analogy). The reliability challenges of early automobiles are nothing like the physics of solar and wind intermittency. This comparison is too vague to be persuasive." }
            ]
        },
        pushback: {
            ...
            rebuttals: [
                { id: 'p1', text: "Every nation must make sacrifices for the planet, and Nigeria is no exception.", correct: false, feedback: "Tone-deaf and dismissive. Telling a developing nation to sacrifice economic development without offering alternatives is neither fair nor persuasive." },
                { id: 'p2', text: "The agreement should include a Green Development Fund that finances renewable infrastructure in nations like Nigeria, allowing you to leapfrog directly to clean energy and create lasting jobs without the long-term costs of fossil fuel dependency.", correct: true, feedback: "Excellent diplomacy. You acknowledged the injustice, offered a concrete financial mechanism, and reframed renewables as an economic opportunity rather than a sacrifice." }
            ]
        },
        speechTemplate: {
